...
class PromotionTestCase(TestCase):
    ...
    def test_promotion_february_data(self):
        ...
        self.assertEqual(promotion_february.end_date, datetime.date(2022, 5, 29)),
