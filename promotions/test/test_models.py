...
class PromotionTestCase(TestCase):
    ...
    def check_remainig_time(self, promotion):
        period = relativedelta(promotion.end_date, NOW)

        if period.seconds < 0:
            self.assertEqual(promotion.remaining_time, f"Esta promoción ha terminado.")
    ...
    def test_Promotion_today_data(self):
        ...
        promotion_today2 = PromotionFactory(
            start_date=now, duration=29, current_time=now
        )

        promotion_today3 = PromotionFactory(
            start_date=now, duration=90, current_time=now
        )
        ...
        self.assertEqual(
            promotion_today.start_date.strftime("%m/%d/%Y"), NOW.strftime("%m/%d/%Y")
        )
    ...
    def test_promotion_january_data(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(2022, 1, 5, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )

        self.assertEqual(
            promotion_january.end_date,
            datetime.datetime(2022, 4, 5, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )

        self.assertEqual(promotion_january.duration, 90)
        self.assertEqual(promotion_january.__str__(), "05 Enero 2022 / 05 Abril 2022")
    ...
    def test_promotion_february_data(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(2022, 2, 28, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(
            promotion_february.end_date,
            datetime.datetime(2022, 5, 29, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(promotion_february.duration, 90)
        self.assertEqual(promotion_february.__str__(), "28 Febrero 2022 / 29 Mayo 2022")
    ...
    def test_promotion_march_data(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(2022, 3, 19, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(
            promotion_march.end_date,
            datetime.datetime(2022, 6, 17, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(promotion_march.duration, 90)
        self.assertEqual(promotion_march.__str__(), "19 Marzo 2022 / 17 Junio 2022")
    ...
    def test_promotion_july_data(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(2022, 7, 24, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(
            promotion_july.end_date,
            datetime.datetime(2022, 10, 22, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(promotion_july.duration, 90)
        self.assertEqual(promotion_july.__str__(), "24 Julio 2022 / 22 Octubre 2022")
    ...
    def test_promotion_august_data(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(2022, 8, 10, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )

        self.assertEqual(
            promotion_august.end_date,
            datetime.datetime(2022, 11, 8, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(promotion_august.duration, 90)
        self.assertEqual(
            promotion_august.__str__(), "10 Agosto 2022 / 08 Noviembre 2022"
        )
    ...
    def test_promotion_september_data(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime(2022, 9, 9, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(
            promotion_september.end_date,
            datetime.datetime(2022, 12, 8, 0, 0, tzinfo=tz.gettz("America/Caracas")),
        )
        self.assertEqual(promotion_september.duration, 90)
        self.assertEqual(
            promotion_september.__str__(), "09 Septiembre 2022 / 08 Diciembre 2022"
        )
